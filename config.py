...
class Config:
    ...
    def __post_init__(self):
        ...
        if self.print_blocks not in [True, False]:
    ...
    def __str__(self):
        return (f"Config (nodes={self.nodes}, miners={self.miners}, hashrate={self.hashrate}, "
                ...
                f"blocksize={self.blocksize}, blocks={self.blocks}, print_blocks={self.print_blocks}, "
                f"debug={self.debug})")